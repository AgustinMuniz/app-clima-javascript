...
let API_KEY = '42a12e23b2f7be007fc447cc71f2c588'
...
function showWeatherData(data) {
    ...
    icoInfo.src = `https://openweathermap.org/img/wn/${icon}@2x.png` // Verificar en la documentación como mostrar una imagen
